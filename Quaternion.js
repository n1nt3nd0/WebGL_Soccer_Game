// all quaternion functions are based on http://www.cs.princeton.edu/~gewang/projects/darth/stuff/quat_faq.html#Q47
// depends on functions found at MatrixMath.js
function Quaternion() {
	this.x = 0.0;
	this.y = 0.0;
	this.z = 0.0;
